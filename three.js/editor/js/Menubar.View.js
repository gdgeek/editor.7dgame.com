...
function MenubarView( editor ) {
	...
	if ( 'xr' in navigator ) {
		...
		if ( 'offerSession' in navigator.xr ) {
			...
			Promise.resolve().then( () => navigator.xr.isSessionSupported( 'immersive-ar' ) )
				.then( function ( supported ) {
					...
					// XR permissions policy may block this in iframes
					console.warn( 'XR session check blocked by permissions policy' );
