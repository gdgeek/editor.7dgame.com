...
function _injectMetaMode( editor: MrppEditor, options: any, factory: any, builder: any, strings: any, resources: Map<string, any>, resourceMenuItems: Map<string, any> ): void {
	...
	const loadResource = async function ( data: any ) {
	...
	const loadResourceBatch = async function ( items: any ) {
	...
	const loadPhototype = async function ( data: any ) {
	...
	const createResourceMenuItem = function ( resourceType: any ) {
...
function _injectVerseMode( editor: MrppEditor, options: any, factory: any, builder: any, strings: any, resources: Map<string, any> ): void {
