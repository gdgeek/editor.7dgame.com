import { UIPanel, UIBreak, UIText, UIButton, UIRow, UIInput } from '../../../three.js/editor/js/libs/ui.js';
...
function SidebarBlockly(editor: MrppEditor): InstanceType<typeof UIPanel> {
	...
	newScript.onClick(function () {
		...
		editor.execute(new (AddScriptCommand as any)(editor, editor.selected, script));
	...
	function update(): void {
		...
		const scripts = (editor as any).scripts[object.uuid];
