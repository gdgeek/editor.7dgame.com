...
class Builder {
	...
	node(type: string, name: string): NodeData {
	...
	resource(data: { type: string; name: string; id: any; src?: string }): NodeData | null {
	...
	module(meta_id: string, title: string = 'Module'): ModuleData {
	...
	anchor(title: string = 'Anchor'): ModuleData {
	...
	text(content: string = 'Hello World'): NodeData {
	...
	phototype(data: { title: string; data?: any; phototype?: any }): NodeData {
