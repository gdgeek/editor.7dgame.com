...
class ComponentContainer {
	...
	handler?: RotateComponent | ActionComponent | MovedComponent | TriggerComponent | TooltipComponent;

	static Create(type: string, editor: MrppEditor): MrppComponent | undefined {
	...
	renderer(container: any): void {
		...
		remove.onClick(function (this: ComponentContainer, event: Event) {
			this.editor.showConfirmation(strings.getKey('sidebar/components/remove/confirm'),
				function (this: ComponentContainer) {
